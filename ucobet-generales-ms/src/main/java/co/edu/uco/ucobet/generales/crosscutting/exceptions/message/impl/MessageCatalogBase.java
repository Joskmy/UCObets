...
public final class MessageCatalogBase implements MessageCatalog {
	...
	public final void initialize() {
		...
		messages.put(MessageCode.M00007.getIdentifier(),
				new Message(MessageCode.M00007, "No existe la ciudad con el id indicado..."));
		...
		messages.put(MessageCode.M00009.getIdentifier(),
				new Message(MessageCode.M00009, "Ya existe una ciudad con el ID proporcionado..."));
		messages.put(MessageCode.M00010.getIdentifier(),
				new Message(MessageCode.M00010, "El id de la ciudad no puede ser nulo..."));
		messages.put(MessageCode.M00011.getIdentifier(),
				new Message(MessageCode.M00011, "Hubo un problema al verificar si la ciudad ya está en uso..."));
		...
		messages.put(MessageCode.M00013.getIdentifier(),
				new Message(MessageCode.M00013, "La ciudad ya está en uso..."));
		...
		messages.put(MessageCode.M00015.getIdentifier(),
				new Message(MessageCode.M00015, "La ciudad  que intentas registrar ya existe para ese estado..."));
		messages.put(MessageCode.M00016.getIdentifier(),
				new Message(MessageCode.M00016, "El nombre de la ciudad no puede estar vacio..."));
		messages.put(MessageCode.M00017.getIdentifier(),
				new Message(MessageCode.M00017, "El nombre de la ciudad no puede ser nulo..."));
		messages.put(MessageCode.M00018.getIdentifier(),
				new Message(MessageCode.M00018, "El nombre de la ciudad no debe tener màs 255 caracteres..."));
